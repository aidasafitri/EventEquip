...
@section('title', 'Edit Kategori - EventEquip')

@section('content')
<div class="mb-8">
    <h1 class="text-4xl font-bold text-slate-900">Edit Kategori</h1>
    <p class="text-slate-600 mt-2 text-lg">Ubah data kategori alat</p>
</div>
