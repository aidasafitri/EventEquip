...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <div class="flex gap-4">
        <a href="{{ route('admin.users.index') }}" class="flex-1 p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
            <div class="text-2xl mb-2">👥</div>
            <p class="font-medium text-gray-900">Kelola User</p>
            <p class="text-xs text-gray-500">Tambah, edit, hapus user</p>
        </a>

        <a href="{{ route('admin.equipments.index') }}" class="flex-1 p-4 bg-green-50 rounded-lg hover:bg-green-100 transition">
            <div class="text-2xl mb-2">🛠️</div>
            <p class="font-medium text-gray-900">Kelola Alat</p>
            <p class="text-xs text-gray-500">Kelola inventori alat</p>
        </a>

        <a href="{{ route('admin.categories.index') }}" class="flex-1 p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
            <div class="text-2xl mb-2">📁</div>
            <p class="font-medium text-gray-900">Kategori Alat</p>
            <p class="text-xs text-gray-500">Kelola kategori</p>
        </a>

        <a href="{{ route('admin.borrowings.index') }}" class="flex-1 p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition">
            <div class="text-2xl mb-2">📋</div>
            <p class="font-medium text-gray-900">Data Peminjaman</p>
            <p class="text-xs text-gray-500">Lihat semua peminjaman</p>
        </a>

        <a href="{{ route('admin.activity-logs.index') }}" class="flex-1 p-4 bg-red-50 rounded-lg hover:bg-red-100 transition">
            <div class="text-2xl mb-2">📝</div>
